...
var mainNav = document.querySelector('[data-nav="main-nav"]');
var mainNavLinks = mainNav.querySelectorAll('[data-nav="main-nav-link"]');
var navToggler = document.querySelector('[data-button="main-nav-toggler"]');
window.addEventListener('DOMContentLoaded', function () {
  var tabletBreakpoint = window.matchMedia('(min-width: 768px)');
  // Utils
  // ---------------------------------
  var onCloseMobileMenu = function onCloseMobileMenu() {
  ...
  window.addEventListener('load', function () {
    if (mainNav && navToggler) {
      ...
      if (mainNavLinks) {
        Array.from(mainNavLinks).forEach(function (item) {
